...
| `structure_database_match_confidence_cutoff` | number (0-1, default 0.8) | Minimum confidence threshold for accepting CSI:FingerID structure annotations. Applies to ConfidenceScoreExact. Higher values indicate stronger agreement between MS/MS data and the predicted structure.                                                                                      |
